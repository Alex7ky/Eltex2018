...
int main()
{
	...
	/* * Destination MAC * */
	socket_address.sll_addr[0] = src_mac[0];
	socket_address.sll_addr[1] = src_mac[1];
	socket_address.sll_addr[2] = src_mac[2];
	socket_address.sll_addr[3] = src_mac[3];
	socket_address.sll_addr[4] = src_mac[4];
	socket_address.sll_addr[5] = src_mac[5];
